...
PATH_TELA_PRINCIPAL =  resource_path("principal_plaintext.ui")
...
def btn_editar_add(index):
    ...
    if janela_editar.btnr_f.isChecked():
        print("Selecionou F")
        sexo = 'F'
    elif janela_editar.btnr_m.isChecked():
        print("Selecionou M")
        sexo = 'M'
    elif janela_editar.btnr_ni.isChecked():
        sexo = 'NI'
    else:
        sexo = 'NI'
...
def btn_salvar_add():
    ...
    if janela_add.btnr_f.isChecked():
        print("Selecionou F")
        sexo = 'F'
    elif janela_add.btnr_m.isChecked():
        print("Selecionou M")
        sexo = 'M'
    elif janela_add.btnr_ni.isChecked():
        sexo = 'NI'
    else:
        sexo = 'NI'
...
def btn_editar():
    ...
    if index != -1:
        ...
        if sexo == 'F':
            ...
            janela_editar.btnr_ni.setChecked(True)
        else:
            janela_editar.btnr_ni.setChecked(True)
        ...
        obj_data = QDate(ano, mes, dia)
        # Seta a os dados da data
        janela_editar.date_data_nasc.setDate(obj_data)
